...
local script_id = "792090734831992886_24_1756808375"
...
local success, script_content = pcall(function()
    return game:HttpGet("https://raw.githubusercontent.com/Rx1m/discord-bot-scripts/main/scripts/792090734831992886/24.lua")
end)
